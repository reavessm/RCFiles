...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'bash', 'c', 'cpp', 'go', 'http', 'json', 'lua', 'python', 'rust', 'tsx', 'typescript', 'vimdoc',
    'vim' },
...
local on_attach = function(_, bufnr)
  ...
  -- @REF [LSP Border](https://vi.stackexchange.com/questions/39074/user-borders-around-lsp-floating-windows/39075#39075)
